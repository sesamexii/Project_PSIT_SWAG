...
import xlrd
def map_thailand():
    """Show map thailand and show the suicide rate in each province, separate male and female in the year 2553."""
    file_2553 = "C:/Users/admin.admin-PC/Desktop/Project_PSIT_SWAG/Data/2540.xls"
    ...
    imap.create_map(path='map_thailand(2553).html')
map_thailand()
